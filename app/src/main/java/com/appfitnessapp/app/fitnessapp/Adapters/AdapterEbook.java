...
public class AdapterEbook extends RecyclerView.Adapter<AdapterEbook.FeedViewHolder>
    ...
    public AdapterEbook(ArrayList<Feed>feeds){

        this.feeds=feeds;
    }

    @Override
    public AdapterEbook.FeedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.usuario_14_diseno,null,false);
        v.setOnClickListener(this);

        AdapterEbook.FeedViewHolder holder=new AdapterEbook.FeedViewHolder(v);
        return holder;
    }


    @Override
    public void onBindViewHolder(@NonNull AdapterEbook.FeedViewHolder holder, int position) {
