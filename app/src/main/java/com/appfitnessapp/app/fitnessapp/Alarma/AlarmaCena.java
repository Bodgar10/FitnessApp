...
public class AlarmaCena extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Cena");
        ...
        final SharedPreferences pref1 = PreferenceManager.getDefaultSharedPreferences(AlarmaCena.this);
       textoNuevo.setText(pref1.getString("key1", ""));
        textoNuevo.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                pref1.edit().putString("key1", s.toString()).commit();
    ...
    private void startAlarm(Calendar c) {
        ...
        Intent intent = new Intent(this, AlertaRecibidaCena.class);
