...
public class AgregarPdf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(AgregarPdf.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    selectImage();
                }
                else {
                    ActivityCompat.requestPermissions(AgregarPdf.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},9);
                }
        ...
        btnPdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(AgregarPdf.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    ...
                    ActivityCompat.requestPermissions(AgregarPdf.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},10);
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (!descripcion.isEmpty()&&pdfUri!=null&&imgUri!=null){
                    ...
                    if (rdGratis.isChecked()){
                        ...
                        Toast.makeText(AgregarPdf.this, "Selecciona el tipo de pdf a subir.", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    Toast.makeText(AgregarPdf.this, "Revisa que tengas todos los campos completos.", Toast.LENGTH_SHORT).show();
                }
    ...
    private void uploadPDF( final String descripcion, final String imgPrincipal, final String timestamp, final String costo,
        ...
        storageReference1.putFile(pdfUri)
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(AgregarPdf.this, "Hubo un error al subir el vídeo.", Toast.LENGTH_SHORT).show();
        ...
        */
        ...
        try {
            ...
            uploadTask2.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AgregarPdf.this, "Hubo un error al subir la imágen.", Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode==9 && grantResults[0]== PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(AgregarPdf.this, "Permite el acceso a la galeria.", Toast.LENGTH_SHORT).show();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==86&& resultCode ==RESULT_OK && data!= null){
            ...
            Toast.makeText(AgregarPdf.this,"Selecciona un archivo", Toast.LENGTH_SHORT).show();
        }
