...
public class AgregarRecetarios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Agregar Recetario");
        ...
        txtSeleccionar.setText("Seleccionar Recetario");
        txtQueTipo.setText("El recetario de que tipo sera:");
        ...
        btnImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(AgregarRecetarios.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    selectImage();
                }
                else {
                    ActivityCompat.requestPermissions(AgregarRecetarios.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},9);
                }
        ...
        btnPdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(AgregarRecetarios.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    ...
                    ActivityCompat.requestPermissions(AgregarRecetarios.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},10);
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (!descripcion.isEmpty()&&pdfUri!=null&&imgUri!=null){
                    ...
                    if (rdGratis.isChecked()){
                        ...
                        Toast.makeText(AgregarRecetarios.this, "Selecciona el tipo de pdf a subir.", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    Toast.makeText(AgregarRecetarios.this, "Revisa que tengas todos los campos completos.", Toast.LENGTH_SHORT).show();
                }
    ...
    private void uploadPDF( final String descripcion, final String imgPrincipal, final String timestamp, final String costo,
        ...
        storageReference1.putFile(pdfUri)
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(AgregarRecetarios.this, "Hubo un error al subir el vídeo.", Toast.LENGTH_SHORT).show();
        ...
        */
        ...
        try {
            ...
            uploadTask2.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AgregarRecetarios.this, "Hubo un error al subir la imágen.", Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode==9 && grantResults[0]== PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(AgregarRecetarios.this, "Permite el acceso a la galeria.", Toast.LENGTH_SHORT).show();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==86&& resultCode ==RESULT_OK && data!= null){
            ...
            Toast.makeText(AgregarRecetarios.this,"Selecciona un archivo", Toast.LENGTH_SHORT).show();
        }
