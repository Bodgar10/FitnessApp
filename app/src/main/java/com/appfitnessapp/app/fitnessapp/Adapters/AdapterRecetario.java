...
public class AdapterRecetario extends RecyclerView.Adapter<AdapterRecetario.FeedViewHolder>
        implements View.OnClickListener{

    AdapterRecetario adapterRecetario;
    ...
    public AdapterRecetario(ArrayList<Feed>feeds){

        this.feeds=feeds;
    }

    @Override
    public AdapterRecetario.FeedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.usuario_14_diseno,null,false);
        v.setOnClickListener(this);

        AdapterRecetario.FeedViewHolder holder=new AdapterRecetario.FeedViewHolder(v);
        return holder;
    }


    @Override
    public void onBindViewHolder(@NonNull AdapterRecetario.FeedViewHolder holder, int position) {
